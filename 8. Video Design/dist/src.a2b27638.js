...
var processRange = document.getElementById("jsProcessBar");
var volumeBtn = document.getElementById("jsVolumeBtn");
var volumeRange = document.getElementById("jsVolumeBar");
...
function setTotalTime() {
  ...
  setInterval(function () {
    processRange.value = Math.floor(videoPlayer.currentTime) / videoPlayer.duration;
  }, 1000);
}
