...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/babel-register/lib/browser.js":[function(require,module,exports) {
"use strict";
...
var ipInfo = document.getElementById("ip");
...
function () {
  ...
  regeneratorRuntime.mark(function _callee() {
    var ip, _ip$data, as, city, country, isp, lat, lon, regionName;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ip = _context.sent;
            _ip$data = ip.data, as = _ip$data.as, city = _ip$data.city, country = _ip$data.country, isp = _ip$data.isp, lat = _ip$data.lat, lon = _ip$data.lon, regionName = _ip$data.regionName;
            console.log(ip);
            ipInfo.innerHTML = "<p>as: ".concat(as, "</p> <p>city: ").concat(city, "</p> <p>country: ").concat(country, "</p> <p>isp: ").concat(isp, "</p> <p>lat: ").concat(lat, "</p> <p>lon: ").concat(lon, "</p> <p>region: ").concat(regionName, "</p>");
...
},{"./styles.css":"src/styles.css","axios":"node_modules/axios/index.js","babel-core/register":"node_modules/babel-core/register.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
